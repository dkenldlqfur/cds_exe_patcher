...
# The library's reading-page text is addressed indirectly: each hint selects
# one of 186 pointers in the original text table.  Store replacements by that
# text ID so the hint record keeps its original association intact.
LIBRARY_HINT_TEXT_SLOT_OFFSET = 0x41000
LIBRARY_HINT_TEXT_SLOT_STRIDE = 0x100
LIBRARY_HINT_TEXT_SLOT_SIZE = LIBRARY_HINT_TEXT_SLOT_STRIDE * 186
...
# Four cannon range/attack entries and replacement name strings.  Keep this
# after both save-slot payloads so older patched executables can grow in place.
CANNON_MASTER_SLOT_OFFSET = 0x4F000
CANNON_MASTER_SLOT_SIZE = 0x100
