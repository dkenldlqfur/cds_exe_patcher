...
def bundled_resource_path(*parts: str) -> Path:
    ...
    if frozen_root:
        ...
        # Runtime helper modules live in Resources/py, whereas callers pass
        # paths relative to the project/resource root (for example
        # Resources/data/city_names.json).
        module_dir = Path(__file__).resolve().parent
        base = module_dir.parent.parent if module_dir.name == "py" and module_dir.parent.name == "Resources" else module_dir
